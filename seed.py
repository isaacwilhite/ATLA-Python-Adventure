...
opponent_data = [
    ...
    ("Yue", "Use the moon to your advantage Avatar! As the moon increases your abilities, you will need to learn how to control them.", "Waterball,Ice Blade,Tidal Wave", 35, 12, "15,17"),
    ("Due", "You’ve merely scratched the surface of your abilities, I've been learning for years. You're no match for me!", "Waterball,Ice Blade,Tidal Wave,Water Jet,Multiple Water Whips", 70, 14, "18"),
...
skill_data = [
    ("Air Blast", "a powerful gust of wind that blasts opponents backwards", 10, "air"),
    ("Air Scooter", "a ball of compressed air that allows the user to move away", 10, "air"),
    ("Air Shield", "a protective barrier of air to block attacks", 20, "air"),
    ("Air Slice", "a sharp blade used for cutting", 15, "air"),
    ("Air Swirl", "a tornado-like vortex to disorient and attack opponents", 20, "air"),
    ("Air Glide", "to glide through the air using bending", 15, "air"),
    ("Rock Throw", "to throw a large rock to damage opponents", 10, "earth"),
    ("Rock Cuffs", "to use the Earth to grab and immobilize your opponent", 15, "earth"),
    ("Rock Armor", "to create a layer of armor out of the earth", 20, "earth"),
    ("Sand Blast", "to generate a big blast of concentrated sand to weaken your opponent", 20, "earth"),
    ("Compressed Rock Bullets", "to turn rocks into bullets to pierce enemy armor", 25, "earth"),
    ("Rock Gloves", "detachable hands, maintaining the hand shape able to grab and restrain the opponent from a distance.", 25, "earth"),
    ("Waterball", "to create a water ball to possibly use as defense or to slow opponents", 10, "water"),
    ("Ice Blade", "something like this Ice blade can be very sharp and might do some damage", 15, "water"),
    ("Water Jet", "to send a blast of water at your opponent", 15, "water"),
    ("Tidal Wave", "to create a massive wave that can harm multiple opponents at once", 20, "water"),
    ("Multiple Water Whips", "something to attack. You need to attack and defend from multiple angles at once", 25, "water"),
    ("Water Compression", "a move with enough power over water to compress its volume, compacting several thousands of gallons into a small volume", 25, "water"),
    ("Blazing Arc", "to creates a crescent-shaped wave of fire that sweeps across the battlefield, engulfing multiple enemies in flame.", 10, "fire"),
    ("Ember Step", "a move that will let you momentarily transforms into a flicker of flame, dashing to a new location. A burst of fire emanates outward, damaging nearby foes.", 15, "fire"),
    ("Inferno Pillar", "to summon a towering pillar of fire directly beneath the target erupting from the ground.", 20, "fire"),
    ("Dragon’s Maw", "to release a concentrated, dragon-shaped burst of flame from their fists or mouth.", 20, "fire"),
    ("Cinder Shield", "a swirling vortex of flames around themselves, which serves as a defense mechanism. Incoming attacks are either incinerated or have their damage significantly reduced while this shield is active.", 15, "fire"),
    ("Phoenix Flight", "to showcase the ultimate display of fire mastery. A skill that allows the firebender to launch into the air surrounded by a fiery aura, and then dive back down to the ground creating a massive explosion on impact.", 30, "fire"),
